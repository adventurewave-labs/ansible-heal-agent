...
by `demo.py` in CI. The suite is 259 tests across `tests/test_agent.py`,
`test_destructive_inputs.py`, `test_safety.py`, `test_perturbation.py`,
`test_real_ansible.py`, `test_runner_inputs.py`, `test_config.py`,
`test_cli.py` and `test_llm.py`.
